...
//             // Ingredients should be sent one by one or as a JSON string
//             if (Array.isArray(recipeData.ingredients)) {
//                 recipeData.ingredients.forEach((item, i) => {
...
//             const response = await axios.put(`http://localhost:3000/recipe/${id}`, formData, {
//                 headers: {
//                     'Content-Type': 'multipart/form-data',
//                     'authorization': 'bearer ' + localStorage.getItem("token")
//                 }
